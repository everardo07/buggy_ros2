...
def generate_launch_description():
    ...
    robot_localization_file_path = os.path.join(params_dir, 'dual_ekf.yaml') 
    ...
    declare_map_yaml_cmd = DeclareLaunchArgument(
        'map',
        default_value=os.path.join(bringup_dir, 'maps', 'map_final.yaml'),
    ...
    declare_rviz_config_file_cmd = DeclareLaunchArgument(
        'rviz_config_file',
        default_value=os.path.join(
            bringup_dir, 'rviz', 'nav2_buggy.rviz'),
  ...
  # Start Gazebo client    
    ...
    ld.add_action(start_loc_local_cmd)
    ld.add_action(start_loc_global_cmd)
