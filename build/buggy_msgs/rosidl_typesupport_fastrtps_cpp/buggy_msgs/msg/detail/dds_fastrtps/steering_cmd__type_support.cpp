...
#include "buggy_msgs/msg/detail/steering_cmd__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const buggy_msgs::msg::SteeringCMD & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.steering_angle_velocity,
    cdr);
  // Member: steering_torque
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.steering_torque,
    cdr);
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  buggy_msgs::msg::SteeringCMD & ros_message)
{
  // Member: steering_angle
...
{
  auto typed_message =
    static_cast<const buggy_msgs::msg::SteeringCMD *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<buggy_msgs::msg::SteeringCMD *>(
    untyped_ros_message);
...
{
  return max_serialized_size_SteeringCMD(full_bounded, 0);
}
...
{
  return &buggy_msgs::msg::typesupport_fastrtps_cpp::_SteeringCMD__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, buggy_msgs, msg, SteeringCMD)() {
  return &buggy_msgs::msg::typesupport_fastrtps_cpp::_SteeringCMD__handle;
}
