...
buggy_msgs__msg__MapmatchingStamped__init(buggy_msgs__msg__MapmatchingStamped * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    buggy_msgs__msg__MapmatchingStamped__fini(msg);
    return false;
  }
  // map_matching
  if (!buggy_msgs__msg__Mapmatching__init(&msg->map_matching)) {
    buggy_msgs__msg__MapmatchingStamped__fini(msg);
    return false;
  }
  return true;
...
buggy_msgs__msg__MapmatchingStamped__fini(buggy_msgs__msg__MapmatchingStamped * msg)
{
  ...
  // map_matching
  buggy_msgs__msg__Mapmatching__fini(&msg->map_matching);
}
...
buggy_msgs__msg__MapmatchingStamped__are_equal(const buggy_msgs__msg__MapmatchingStamped * lhs, const buggy_msgs__msg__MapmatchingStamped * rhs)
{
  ...
  // map_matching
  if (!buggy_msgs__msg__Mapmatching__are_equal(
...
buggy_msgs__msg__MapmatchingStamped__create()
{
  ...
  buggy_msgs__msg__MapmatchingStamped * msg = (buggy_msgs__msg__MapmatchingStamped *)allocator.allocate(sizeof(buggy_msgs__msg__MapmatchingStamped), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(buggy_msgs__msg__MapmatchingStamped));
  bool success = buggy_msgs__msg__MapmatchingStamped__init(msg);
  if (!success) {
...
buggy_msgs__msg__MapmatchingStamped__Sequence__init(buggy_msgs__msg__MapmatchingStamped__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  buggy_msgs__msg__MapmatchingStamped * data = NULL;

  if (size) {
    data = (buggy_msgs__msg__MapmatchingStamped *)allocator.zero_allocate(size, sizeof(buggy_msgs__msg__MapmatchingStamped), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = buggy_msgs__msg__MapmatchingStamped__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        buggy_msgs__msg__MapmatchingStamped__fini(&data[i - 1]);
      }
...
buggy_msgs__msg__MapmatchingStamped__Sequence__fini(buggy_msgs__msg__MapmatchingStamped__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      buggy_msgs__msg__MapmatchingStamped__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  buggy_msgs__msg__MapmatchingStamped__Sequence * array = (buggy_msgs__msg__MapmatchingStamped__Sequence *)allocator.allocate(sizeof(buggy_msgs__msg__MapmatchingStamped__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = buggy_msgs__msg__MapmatchingStamped__Sequence__init(array, size);
  if (!success) {
...
buggy_msgs__msg__MapmatchingStamped__Sequence__destroy(buggy_msgs__msg__MapmatchingStamped__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    buggy_msgs__msg__MapmatchingStamped__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
buggy_msgs__msg__MapmatchingStamped__Sequence__are_equal(const buggy_msgs__msg__MapmatchingStamped__Sequence * lhs, const buggy_msgs__msg__MapmatchingStamped__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!buggy_msgs__msg__MapmatchingStamped__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  buggy_msgs__msg__MapmatchingStamped__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(buggy_msgs__msg__MapmatchingStamped);
    buggy_msgs__msg__MapmatchingStamped * data =
      (buggy_msgs__msg__MapmatchingStamped *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!buggy_msgs__msg__MapmatchingStamped__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          buggy_msgs__msg__MapmatchingStamped__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!buggy_msgs__msg__MapmatchingStamped__copy(
