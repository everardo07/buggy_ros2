...
static const _GNSSStateStamped_type_support_symbol_names_t _GNSSStateStamped_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, buggy_msgs, msg, GNSSStateStamped)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, buggy_msgs, msg, GNSSStateStamped)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, buggy_msgs, msg, GNSSStateStamped)() {
  return &::buggy_msgs::msg::rosidl_typesupport_c::GNSSStateStamped_message_type_support_handle;
}
