...
static const _SteeringWheelStateStamped_type_support_symbol_names_t _SteeringWheelStateStamped_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, buggy_msgs, msg, SteeringWheelStateStamped)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, buggy_msgs, msg, SteeringWheelStateStamped)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, buggy_msgs, msg, SteeringWheelStateStamped)() {
  return &::buggy_msgs::msg::rosidl_typesupport_c::SteeringWheelStateStamped_message_type_support_handle;
}
