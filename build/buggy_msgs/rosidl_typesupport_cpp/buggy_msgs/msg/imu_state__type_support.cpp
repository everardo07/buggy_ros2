...
static const _IMUState_type_support_symbol_names_t _IMUState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, buggy_msgs, msg, IMUState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, buggy_msgs, msg, IMUState)),
  }
};
...
{
  return &::buggy_msgs::msg::rosidl_typesupport_cpp::IMUState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, buggy_msgs, msg, IMUState)() {
  return get_message_type_support_handle<buggy_msgs::msg::IMUState>();
}
