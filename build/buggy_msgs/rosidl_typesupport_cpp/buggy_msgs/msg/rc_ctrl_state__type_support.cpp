...
static const _RCCtrlState_type_support_symbol_names_t _RCCtrlState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, buggy_msgs, msg, RCCtrlState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, buggy_msgs, msg, RCCtrlState)),
  }
};
...
{
  return &::buggy_msgs::msg::rosidl_typesupport_cpp::RCCtrlState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, buggy_msgs, msg, RCCtrlState)() {
  return get_message_type_support_handle<buggy_msgs::msg::RCCtrlState>();
}
