...
{
  new (message_memory) buggy_msgs::msg::VehicleState(_init);
}

void VehicleState_fini_function(void * message_memory)
{
  auto typed_message = static_cast<buggy_msgs::msg::VehicleState *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember VehicleState_message_member_array[3] = {
  {
    ...
    offsetof(buggy_msgs::msg::VehicleState, wheels),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(buggy_msgs::msg::VehicleState, steering_wheel),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(buggy_msgs::msg::VehicleState, acceleration),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers VehicleState_message_members = {
  ...
  3,  // number of fields
  sizeof(buggy_msgs::msg::VehicleState),
...
{
  return &::buggy_msgs::msg::rosidl_typesupport_introspection_cpp::VehicleState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, buggy_msgs, msg, VehicleState)() {
  return &::buggy_msgs::msg::rosidl_typesupport_introspection_cpp::VehicleState_message_type_support_handle;
}
