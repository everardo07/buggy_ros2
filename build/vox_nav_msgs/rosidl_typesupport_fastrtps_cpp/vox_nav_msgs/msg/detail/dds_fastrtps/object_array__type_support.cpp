...
#include "vox_nav_msgs/msg/detail/object_array__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: objects
  {
    ...
    for (size_t i = 0; i < size; i++) {
      vox_nav_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
  ...
  vox_nav_msgs::msg::ObjectArray & ros_message)
{
  ...
  // Member: objects
  {
    ...
    for (size_t i = 0; i < size; i++) {
      vox_nav_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: objects
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        vox_nav_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: objects
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        vox_nav_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Object(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const vox_nav_msgs::msg::ObjectArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vox_nav_msgs::msg::ObjectArray *>(
    untyped_ros_message);
...
{
  return &vox_nav_msgs::msg::typesupport_fastrtps_cpp::_ObjectArray__handle;
}
