...
static const _GetOctomap_Request_type_support_symbol_names_t _GetOctomap_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vox_nav_msgs, srv, GetOctomap_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vox_nav_msgs, srv, GetOctomap_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, vox_nav_msgs, srv, GetOctomap_Request)() {
  return &::vox_nav_msgs::srv::rosidl_typesupport_c::GetOctomap_Request_message_type_support_handle;
}
...
static const _GetOctomap_Response_type_support_symbol_names_t _GetOctomap_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vox_nav_msgs, srv, GetOctomap_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vox_nav_msgs, srv, GetOctomap_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_vox_nav_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, vox_nav_msgs, srv, GetOctomap_Response)() {
  return &::vox_nav_msgs::srv::rosidl_typesupport_c::GetOctomap_Response_message_type_support_handle;
}
...
static const _GetOctomap_type_support_symbol_names_t _GetOctomap_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vox_nav_msgs, srv, GetOctomap)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vox_nav_msgs, srv, GetOctomap)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, vox_nav_msgs, srv, GetOctomap)() {
  return &::vox_nav_msgs::srv::rosidl_typesupport_c::GetOctomap_service_type_support_handle;
}
