...
class ComputePathToPose_SendGoal_Request(metaclass=Metaclass_ComputePathToPose_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'vox_nav_msgs/ComputePathToPose_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['vox_nav_msgs', 'action'], 'ComputePathToPose_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from vox_nav_msgs.action._compute_path_to_pose import ComputePathToPose_Goal
...
class Metaclass_ComputePathToPose_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'vox_nav_msgs.action.ComputePathToPose_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from vox_nav_msgs.action import _compute_path_to_pose
...
class ComputePathToPose_SendGoal(metaclass=Metaclass_ComputePathToPose_SendGoal):
    from vox_nav_msgs.action._compute_path_to_pose import ComputePathToPose_SendGoal_Request as Request
    from vox_nav_msgs.action._compute_path_to_pose import ComputePathToPose_SendGoal_Response as Response
...
class ComputePathToPose_GetResult_Response(metaclass=Metaclass_ComputePathToPose_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'vox_nav_msgs/ComputePathToPose_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['vox_nav_msgs', 'action'], 'ComputePathToPose_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from vox_nav_msgs.action._compute_path_to_pose import ComputePathToPose_Result
...
class Metaclass_ComputePathToPose_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'vox_nav_msgs.action.ComputePathToPose_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class ComputePathToPose_GetResult(metaclass=Metaclass_ComputePathToPose_GetResult):
    from vox_nav_msgs.action._compute_path_to_pose import ComputePathToPose_GetResult_Request as Request
    from vox_nav_msgs.action._compute_path_to_pose import ComputePathToPose_GetResult_Response as Response
...
class Metaclass_ComputePathToPose_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'vox_nav_msgs.action.ComputePathToPose_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class ComputePathToPose_FeedbackMessage(metaclass=Metaclass_ComputePathToPose_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'vox_nav_msgs/ComputePathToPose_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['vox_nav_msgs', 'action'], 'ComputePathToPose_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from vox_nav_msgs.action._compute_path_to_pose import ComputePathToPose_Feedback
...
class Metaclass_ComputePathToPose(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'vox_nav_msgs.action.ComputePathToPose')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class ComputePathToPose(metaclass=Metaclass_ComputePathToPose):
    ...
    from vox_nav_msgs.action._compute_path_to_pose import ComputePathToPose_Goal as Goal
    # The result message defined in the action definition.
    from vox_nav_msgs.action._compute_path_to_pose import ComputePathToPose_Result as Result
    # The feedback message defined in the action definition.
    from vox_nav_msgs.action._compute_path_to_pose import ComputePathToPose_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from vox_nav_msgs.action._compute_path_to_pose import ComputePathToPose_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from vox_nav_msgs.action._compute_path_to_pose import ComputePathToPose_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from vox_nav_msgs.action._compute_path_to_pose import ComputePathToPose_FeedbackMessage as FeedbackMessage
