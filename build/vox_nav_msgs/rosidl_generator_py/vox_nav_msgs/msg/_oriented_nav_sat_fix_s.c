...
bool vox_nav_msgs__msg__oriented_nav_sat_fix__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vox_nav_msgs.msg._oriented_nav_sat_fix.OrientedNavSatFix", full_classname_dest, 56) == 0);
  }
  vox_nav_msgs__msg__OrientedNavSatFix * ros_message = _ros_message;
  {  // position
    PyObject * field = PyObject_GetAttrString(_pymsg, "position");
    if (!field) {
      return false;
    }
    if (!sensor_msgs__msg__nav_sat_fix__convert_from_py(field, &ros_message->position)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of OrientedNavSatFix */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("vox_nav_msgs.msg._oriented_nav_sat_fix");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "OrientedNavSatFix");
