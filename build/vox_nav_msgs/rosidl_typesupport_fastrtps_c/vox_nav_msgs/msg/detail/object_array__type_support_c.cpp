...
#include "vox_nav_msgs/msg/detail/object_array__rosidl_typesupport_fastrtps_c.h"
...
#include "vox_nav_msgs/msg/detail/object__functions.h"  // objects
...
using _ObjectArray__ros_msg_type = vox_nav_msgs__msg__ObjectArray;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: objects
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, vox_nav_msgs, msg, Object
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: objects
  {
    ...
    if (ros_message->objects.data) {
      vox_nav_msgs__msg__Object__Sequence__fini(&ros_message->objects);
    }
...
size_t get_serialized_size_vox_nav_msgs__msg__ObjectArray(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ObjectArray__ros_msg_type * ros_message = static_cast<const _ObjectArray__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name objects
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_vox_nav_msgs__msg__Object(
...
static uint32_t _ObjectArray__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vox_nav_msgs__msg__ObjectArray(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vox_nav_msgs
size_t max_serialized_size_vox_nav_msgs__msg__ObjectArray(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
  ...
  // member: objects
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_vox_nav_msgs__msg__Object(
        full_bounded, current_alignment);
    }
  }
...
{
  return max_serialized_size_vox_nav_msgs__msg__ObjectArray(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vox_nav_msgs, msg, ObjectArray)() {
