...
class FollowPath_Result(metaclass=Metaclass_FollowPath_Result):
    ...
    _fields_and_field_types = {
        'total_time': 'builtin_interfaces/Duration',
    }
    ...
    def __init__(self, **kwargs):
        assert all('_' + key in self.__slots__ for key in kwargs.keys()), \
            ...
            ', '.join(sorted(k for k in kwargs.keys() if '_' + k not in self.__slots__))
        from builtin_interfaces.msg import Duration
        self.total_time = kwargs.get('total_time', Duration())
    ...
    def total_time(self, value):
        if __debug__:
            ...
            assert \
                ...
                "The 'total_time' field must be a sub message of type 'Duration'"
...
class Metaclass_FollowPath_SendGoal_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from vox_nav_msgs.action import FollowPath
...
class FollowPath_SendGoal_Request(metaclass=Metaclass_FollowPath_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'vox_nav_msgs/FollowPath_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['vox_nav_msgs', 'action'], 'FollowPath_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from vox_nav_msgs.action._follow_path import FollowPath_Goal
...
class Metaclass_FollowPath_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'vox_nav_msgs.action.FollowPath_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from vox_nav_msgs.action import _follow_path
...
class FollowPath_SendGoal(metaclass=Metaclass_FollowPath_SendGoal):
    from vox_nav_msgs.action._follow_path import FollowPath_SendGoal_Request as Request
    from vox_nav_msgs.action._follow_path import FollowPath_SendGoal_Response as Response
...
class FollowPath_GetResult_Response(metaclass=Metaclass_FollowPath_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'vox_nav_msgs/FollowPath_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['vox_nav_msgs', 'action'], 'FollowPath_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from vox_nav_msgs.action._follow_path import FollowPath_Result
...
class Metaclass_FollowPath_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'vox_nav_msgs.action.FollowPath_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class FollowPath_GetResult(metaclass=Metaclass_FollowPath_GetResult):
    from vox_nav_msgs.action._follow_path import FollowPath_GetResult_Request as Request
    from vox_nav_msgs.action._follow_path import FollowPath_GetResult_Response as Response
...
class Metaclass_FollowPath_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'vox_nav_msgs.action.FollowPath_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class FollowPath_FeedbackMessage(metaclass=Metaclass_FollowPath_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'vox_nav_msgs/FollowPath_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['vox_nav_msgs', 'action'], 'FollowPath_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from vox_nav_msgs.action._follow_path import FollowPath_Feedback
...
class Metaclass_FollowPath(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'vox_nav_msgs.action.FollowPath')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class FollowPath(metaclass=Metaclass_FollowPath):
    ...
    from vox_nav_msgs.action._follow_path import FollowPath_Goal as Goal
    # The result message defined in the action definition.
    from vox_nav_msgs.action._follow_path import FollowPath_Result as Result
    # The feedback message defined in the action definition.
    from vox_nav_msgs.action._follow_path import FollowPath_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from vox_nav_msgs.action._follow_path import FollowPath_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from vox_nav_msgs.action._follow_path import FollowPath_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from vox_nav_msgs.action._follow_path import FollowPath_FeedbackMessage as FeedbackMessage
