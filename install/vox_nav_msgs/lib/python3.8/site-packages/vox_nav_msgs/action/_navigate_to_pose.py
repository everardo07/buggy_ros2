...
class Metaclass_NavigateToPose_SendGoal_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from vox_nav_msgs.action import NavigateToPose
...
class NavigateToPose_SendGoal_Request(metaclass=Metaclass_NavigateToPose_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'vox_nav_msgs/NavigateToPose_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['vox_nav_msgs', 'action'], 'NavigateToPose_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from vox_nav_msgs.action._navigate_to_pose import NavigateToPose_Goal
...
class Metaclass_NavigateToPose_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'vox_nav_msgs.action.NavigateToPose_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from vox_nav_msgs.action import _navigate_to_pose
...
class NavigateToPose_SendGoal(metaclass=Metaclass_NavigateToPose_SendGoal):
    from vox_nav_msgs.action._navigate_to_pose import NavigateToPose_SendGoal_Request as Request
    from vox_nav_msgs.action._navigate_to_pose import NavigateToPose_SendGoal_Response as Response
...
class NavigateToPose_GetResult_Response(metaclass=Metaclass_NavigateToPose_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'vox_nav_msgs/NavigateToPose_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['vox_nav_msgs', 'action'], 'NavigateToPose_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from vox_nav_msgs.action._navigate_to_pose import NavigateToPose_Result
...
class Metaclass_NavigateToPose_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'vox_nav_msgs.action.NavigateToPose_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class NavigateToPose_GetResult(metaclass=Metaclass_NavigateToPose_GetResult):
    from vox_nav_msgs.action._navigate_to_pose import NavigateToPose_GetResult_Request as Request
    from vox_nav_msgs.action._navigate_to_pose import NavigateToPose_GetResult_Response as Response
...
class Metaclass_NavigateToPose_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'vox_nav_msgs.action.NavigateToPose_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class NavigateToPose_FeedbackMessage(metaclass=Metaclass_NavigateToPose_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'vox_nav_msgs/NavigateToPose_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['vox_nav_msgs', 'action'], 'NavigateToPose_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from vox_nav_msgs.action._navigate_to_pose import NavigateToPose_Feedback
...
class Metaclass_NavigateToPose(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'vox_nav_msgs.action.NavigateToPose')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class NavigateToPose(metaclass=Metaclass_NavigateToPose):
    ...
    from vox_nav_msgs.action._navigate_to_pose import NavigateToPose_Goal as Goal
    # The result message defined in the action definition.
    from vox_nav_msgs.action._navigate_to_pose import NavigateToPose_Result as Result
    # The feedback message defined in the action definition.
    from vox_nav_msgs.action._navigate_to_pose import NavigateToPose_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from vox_nav_msgs.action._navigate_to_pose import NavigateToPose_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from vox_nav_msgs.action._navigate_to_pose import NavigateToPose_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from vox_nav_msgs.action._navigate_to_pose import NavigateToPose_FeedbackMessage as FeedbackMessage
