...
#ifndef VOX_NAV_MSGS__SRV__DETAIL__GET_OCTOMAP__FUNCTIONS_H_
#define VOX_NAV_MSGS__SRV__DETAIL__GET_OCTOMAP__FUNCTIONS_H_
 ...
 * calls
 * vox_nav_msgs__srv__GetOctomap_Request__init().
...
/**
 * It calls
 * vox_nav_msgs__srv__GetOctomap_Request__fini()
 ...
 * vox_nav_msgs__srv__GetOctomap_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * vox_nav_msgs__srv__GetOctomap_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * vox_nav_msgs__srv__GetOctomap_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_vox_nav_msgs
...
/**
 * It calls
 * vox_nav_msgs__srv__GetOctomap_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_vox_nav_msgs
...
/**
 * It allocates the memory for the array and calls
 * vox_nav_msgs__srv__GetOctomap_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_vox_nav_msgs
...
/**
 * It calls
 * vox_nav_msgs__srv__GetOctomap_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // VOX_NAV_MSGS__SRV__DETAIL__GET_OCTOMAP__FUNCTIONS_H_
